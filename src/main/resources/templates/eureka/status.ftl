...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  ...
  <body id="one">
                  ...
                  <#list app.instanceInfos as instanceInfo>
                    ...
                    <#list instanceInfo.instances as instance>
                      <#if instance.isHref>
                          ...
                          <a href="" onclick="changeStatus('${app.name}','${instance.id}', 'OUT_OF_SERVICE')">强制剔除</a>
                          <a href="" onclick="changeStatus('${app.name}','${instance.id}', 'UP')">强制恢复</a>
                          <a href="" onclick="changeStatus('${app.name}','${instance.id}', 'DOWN')">强制下线</a>
                      <#else>
                        ${instance.id}
    ...
    <script type="text/javascript">
       ...
       function changeStatus(appName, instanceId, status) {
           $.ajax({
               url: '/eureka/apps/'+ appName + '/' + instanceId + '/status?value=' + status,
               type: 'PUT',
